...
export const ImageComparator = forwardRef<
  ImageComparatorHandle,
  ImageComparatorProps
>(({ beforeImage, afterImage }, ref) => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full aspect-video overflow-hidden rounded-lg shadow-lg select-none group"
...
ImageComparator.displayName = 'ImageComparator';